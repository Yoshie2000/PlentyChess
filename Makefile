...
ifeq ($(arch), android)
	...
	CXXFLAGS := $(CXXFLAGS) -DARCH_X86 -mssse3 -mfma -finline-functions -fno-exceptions -pipe -fno-rtti -fstrict-aliasing -fomit-frame-pointer -fsee
	CFLAGS := $(CFLAGS) -mssse3 -mfma -finline-functions -fno-exceptions -pipe -fno-rtti -fstrict-aliasing -fomit-frame-pointer -fsee
else ifeq ($(arch), ssse3)
	CXXFLAGS := $(CXXFLAGS) -DARCH_X86 -mssse3 -finline-functions -fno-exceptions -pipe -fno-rtti -fstrict-aliasing -fomit-frame-pointer -fsee
	CFLAGS := $(CFLAGS) -mssse3 -finline-functions -fno-exceptions -pipe -fno-rtti -fstrict-aliasing -fomit-frame-pointer -fsee
else ifeq ($(arch), generic)
	CXXFLAGS := $(CXXFLAGS) -DARCH_X86 -finline-functions -fno-exceptions -pipe -fno-rtti -fstrict-aliasing -fomit-frame-pointer -fsee
	CFLAGS := $(CFLAGS) -finline-functions -fno-exceptions -pipe -fno-rtti -fstrict-aliasing -fomit-frame-pointer -fsee
else
