...
Eval NNUE::evaluate(Board* board) {
    ...
    for (int l1 = 0; l1 < pairwiseOffset; l1 += 2) {
        ...
        VecI16 clipped2 = minEpi16(addEpi16(stmPieceAcc[l1 + pairwiseOffset], stmPieceAcc[l1 + pairwiseOffset]), i16Quant);
        ...
        clipped2 = minEpi16(addEpi16(stmPieceAcc[l1 + pairwiseOffset + 1], stmPieceAcc[l1 + pairwiseOffset + 1]), i16Quant);
        ...
        clipped2 = minEpi16(addEpi16(oppPieceAcc[l1 + pairwiseOffset], oppPieceAcc[l1 + pairwiseOffset]), i16Quant);
        shift = slliEpi16(clipped1, inverseShift);
        mul1 = mulhiEpi16(shift, clipped2);

        clipped1 = minEpi16(maxEpi16(addEpi16(oppThreatAcc[l1 + 1], oppPieceAcc[l1 + 1]), i16Zero), i16Quant);
        clipped2 = minEpi16(addEpi16(oppPieceAcc[l1 + pairwiseOffset + 1], oppPieceAcc[l1 + pairwiseOffset + 1]), i16Quant);
        shift = slliEpi16(clipped1, inverseShift);
