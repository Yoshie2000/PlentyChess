...
void NNUE::reset(Board* board) {
    ...
    l3Weights[0][0] = 0.4322388796755099;
    l3Weights[0][1] = -0.9812573339449352;
    l3Weights[0][2] = 0.23958372137820855;
    l3Weights[0][3] = -0.8803253867168896;
    l3Weights[0][4] = -0.6206881683314261;
    l3Weights[0][5] = -0.5793442238980575;
    l3Weights[0][6] = -0.7656603803992741;
    l3Weights[0][7] = -1.0092749181884957;
    l3Weights[0][8] = -0.2709824777145435;
    l3Weights[0][9] = 1.038870831329819;
    l3Weights[0][10] = -0.3803619084452858;
    l3Weights[0][11] = -0.04942995995562381;
    l3Weights[0][12] = 1.0186542853663618;
    l3Weights[0][13] = -0.3187865639638809;
    l3Weights[0][14] = -2.9296523564675167e-07;
    l3Weights[0][15] = 0.12753409572554347;
    l3Weights[0][16] = -0.9578487255245968;
    l3Weights[0][17] = 0.4617273428688788;
    l3Weights[0][18] = -0.6321298597254037;
    l3Weights[0][19] = 0.557147895628867;
    l3Weights[0][20] = 5.6210572422832947e-08;
    l3Weights[0][21] = 0.8589989432583878;
    l3Weights[0][22] = -0.9952472433246392;
    l3Weights[0][23] = 1.0003217707384715;
    l3Weights[0][24] = -0.49504494571100593;
    l3Weights[0][25] = 0.3159248404505933;
    l3Weights[0][26] = 0.4138471488634391;
    l3Weights[0][27] = -0.724346913330075;
    l3Weights[0][28] = -4.998896316069258e-07;
    l3Weights[0][29] = 0.36732596369200904;
    l3Weights[0][30] = 1.028520543445347;
    l3Weights[0][31] = -0.2619550373959021;
    l3Weights[0][32] = 0.0641590082305288;
    l3Weights[0][33] = -0.05877357831862218;
    l3Weights[0][34] = -0.022046947174708672;
    l3Weights[0][35] = 0.0702343913117819;
    l3Weights[0][36] = -0.027317971876925983;
    l3Weights[0][37] = 0.008638652399699307;
    l3Weights[0][38] = -0.018034178635152366;
    l3Weights[0][39] = 0.01162196081375283;
    l3Weights[0][40] = -0.0150808731253402;
    l3Weights[0][41] = -0.0335945925999957;
    l3Weights[0][42] = 0.024984850255444096;
    l3Weights[0][43] = -0.027194140731698645;
    l3Weights[0][44] = 0.009524050570522871;
    l3Weights[0][45] = -0.06901446605391867;
    l3Weights[0][46] = -0.0534962761267625;
    l3Weights[0][47] = 0.014227822061024296;
    l3Weights[0][48] = 0.002704217380035537;
    l3Weights[0][49] = 0.0626831374424341;
    l3Weights[0][50] = -0.014465112095466843;
    l3Weights[0][51] = 0.0011271921032071745;
    l3Weights[0][52] = 0.013379011860990341;
    l3Weights[0][53] = -0.0547494812926515;
    l3Weights[0][54] = 0.03402145984023177;
    l3Weights[0][55] = -0.017534846220216144;
    l3Weights[0][56] = 0.021694296707009394;
    l3Weights[0][57] = 0.03803170083971299;
    l3Weights[0][58] = 0.01289354889742171;
    l3Weights[0][59] = 0.016207429209097804;
    l3Weights[0][60] = -0.012044218820441384;
    l3Weights[0][61] = 0.0012811220361027707;
    l3Weights[0][62] = 0.035213843253615575;
    l3Weights[0][63] = -0.010374121347288694;
    l3Weights[1][0] = -0.996251974540002;
    l3Weights[1][1] = -1.0049190773716463;
    l3Weights[1][2] = -0.36385054464752414;
    l3Weights[1][3] = -0.9107595262682854;
    l3Weights[1][4] = 0.9788080833421554;
    l3Weights[1][5] = -1.001383598040452;
    l3Weights[1][6] = -1.0122211320455834;
    l3Weights[1][7] = -0.9845635503558521;
    l3Weights[1][8] = -0.987980589496119;
    l3Weights[1][9] = -0.9481330527927119;
    l3Weights[1][10] = -5.338829612741889e-08;
    l3Weights[1][11] = 0.9761279539251904;
    l3Weights[1][12] = -0.7857785197649939;
    l3Weights[1][13] = -1.7809670541450918e-07;
    l3Weights[1][14] = 0.9873881808197194;
    l3Weights[1][15] = -0.5982932316330728;
    l3Weights[1][16] = -0.3548094109137367;
    l3Weights[1][17] = -0.258591471851195;
    l3Weights[1][18] = 0.32308890012812713;
    l3Weights[1][19] = -0.5383968493940179;
    l3Weights[1][20] = 0.9668356381682668;
    l3Weights[1][21] = 0.954643863696033;
    l3Weights[1][22] = -1.0289139181822382;
    l3Weights[1][23] = -0.8316157057664184;
    l3Weights[1][24] = -0.9976436774884857;
    l3Weights[1][25] = -1.0003256083502812;
    l3Weights[1][26] = 0.5899468429361602;
    l3Weights[1][27] = -0.6037890408701604;
    l3Weights[1][28] = 0.8356282280849039;
    l3Weights[1][29] = -0.6414030165169105;
    l3Weights[1][30] = -0.24310268627063145;
    l3Weights[1][31] = -0.9867116650542636;
    l3Weights[1][32] = 0.06950645145586415;
    l3Weights[1][33] = -0.045269088236677024;
    l3Weights[1][34] = -0.13573209699576735;
    l3Weights[1][35] = -0.08783786258419007;
    l3Weights[1][36] = -0.2721343120630844;
    l3Weights[1][37] = 0.060651990525761465;
    l3Weights[1][38] = 0.46843831241988787;
    l3Weights[1][39] = 0.1807064486329318;
    l3Weights[1][40] = 0.04580163462544065;
    l3Weights[1][41] = 0.10355451317341188;
    l3Weights[1][42] = -0.17297246823309376;
    l3Weights[1][43] = 0.5842152799319927;
    l3Weights[1][44] = 0.10019439272476548;
    l3Weights[1][45] = -0.2229107340981051;
    l3Weights[1][46] = 0.42483054079541777;
    l3Weights[1][47] = 0.13320472618230322;
    l3Weights[1][48] = 0.06998467493599984;
    l3Weights[1][49] = 0.09758219779877311;
    l3Weights[1][50] = 0.1592572140376395;
    l3Weights[1][51] = -0.022583365000280537;
    l3Weights[1][52] = 0.24254814627670349;
    l3Weights[1][53] = -0.013403914618744404;
    l3Weights[1][54] = 0.09102095437270193;
    l3Weights[1][55] = -0.006473794751191713;
    l3Weights[1][56] = 0.20871648087474384;
    l3Weights[1][57] = 0.01078345599880464;
    l3Weights[1][58] = -0.016677637134889664;
    l3Weights[1][59] = 0.18886706597067698;
    l3Weights[1][60] = 0.2883023514851579;
    l3Weights[1][61] = 0.2537098108763606;
    l3Weights[1][62] = 0.19971271975517915;
    l3Weights[1][63] = -0.07978684325168234;
    l3Weights[2][0] = 1.0036961630193542;
    l3Weights[2][1] = -2.5885702565754044e-07;
    l3Weights[2][2] = 1.0244876364963982;
    l3Weights[2][3] = 0.42661511595300855;
    l3Weights[2][4] = 1.0354361666764533;
    l3Weights[2][5] = 1.073656254177912;
    l3Weights[2][6] = -0.9457423516879048;
    l3Weights[2][7] = 0.5003312321578188;
    l3Weights[2][8] = -0.9616086529262843;
    l3Weights[2][9] = 0.9784607441370327;
    l3Weights[2][10] = -0.2410241662066984;
    l3Weights[2][11] = -0.9565124307951566;
    l3Weights[2][12] = -1.0281852041495823;
    l3Weights[2][13] = -1.0228846985748494;
    l3Weights[2][14] = -0.621890565436311;
    l3Weights[2][15] = -0.9771294680528447;
    l3Weights[2][16] = -0.6310857505341384;
    l3Weights[2][17] = 0.9945858437196571;
    l3Weights[2][18] = -1.0083111398628544;
    l3Weights[2][19] = 0.9607637415693437;
    l3Weights[2][20] = 1.5687690165104016e-07;
    l3Weights[2][21] = -0.388057998318432;
    l3Weights[2][22] = -0.9857703812800508;
    l3Weights[2][23] = -4.4079775765039197e-07;
    l3Weights[2][24] = 0.9653617154787948;
    l3Weights[2][25] = 0.6931418739393501;
    l3Weights[2][26] = -0.7715669413566951;
    l3Weights[2][27] = 4.0315608356972473e-07;
    l3Weights[2][28] = -0.9758535163173924;
    l3Weights[2][29] = -0.9573425744562932;
    l3Weights[2][30] = 1.0029759009547599;
    l3Weights[2][31] = -1.0262749576515116;
    l3Weights[2][32] = 0.003691312749127402;
    l3Weights[2][33] = -0.20773867415157013;
    l3Weights[2][34] = -0.14698322697279395;
    l3Weights[2][35] = -0.2866197136031973;
    l3Weights[2][36] = 0.06231923436690624;
    l3Weights[2][37] = 0.32811890591450527;
    l3Weights[2][38] = 0.12326025732561018;
    l3Weights[2][39] = 0.6177053893829818;
    l3Weights[2][40] = 0.1788706028559592;
    l3Weights[2][41] = -0.01431981665520311;
    l3Weights[2][42] = 0.20363378052125122;
    l3Weights[2][43] = 0.25115510269318664;
    l3Weights[2][44] = 0.17897452014249376;
    l3Weights[2][45] = 0.18674220084425283;
    l3Weights[2][46] = 0.06326270767774353;
    l3Weights[2][47] = -0.2043699856068077;
    l3Weights[2][48] = 0.014318541582866546;
    l3Weights[2][49] = -0.10379746427231223;
    l3Weights[2][50] = 0.22704218957646355;
    l3Weights[2][51] = 0.06717697978744329;
    l3Weights[2][52] = -0.10762308458208084;
    l3Weights[2][53] = 0.4531366225353342;
    l3Weights[2][54] = -0.07291308793145977;
    l3Weights[2][55] = -0.009606124784499227;
    l3Weights[2][56] = -0.007936242744225332;
    l3Weights[2][57] = -0.09480687064549075;
    l3Weights[2][58] = -0.22983848107601604;
    l3Weights[2][59] = 0.0035940524075649873;
    l3Weights[2][60] = -0.03550095027965749;
    l3Weights[2][61] = 0.3029445723943951;
    l3Weights[2][62] = 0.012257029012408247;
    l3Weights[2][63] = -0.053814393693337;
    l3Weights[3][0] = -0.9879725250410184;
    l3Weights[3][1] = -0.9732403727003837;
    l3Weights[3][2] = 9.83314172741357e-08;
    l3Weights[3][3] = 1.0474765741932233;
    l3Weights[3][4] = -1.0106130353101677;
    l3Weights[3][5] = -0.39642328690067663;
    l3Weights[3][6] = 0.6746478417757824;
    l3Weights[3][7] = -0.7597723838855314;
    l3Weights[3][8] = -0.9492730915337879;
    l3Weights[3][9] = 0.9836146963436265;
    l3Weights[3][10] = 0.9994323288513005;
    l3Weights[3][11] = -1.0361346930339195;
    l3Weights[3][12] = 0.9953064542293022;
    l3Weights[3][13] = 0.9629946196036957;
    l3Weights[3][14] = 1.000462486820416;
    l3Weights[3][15] = 0.33781193325409153;
    l3Weights[3][16] = 0.56578995961907;
    l3Weights[3][17] = -0.9812728797698119;
    l3Weights[3][18] = 0.6236182310307562;
    l3Weights[3][19] = 0.9964269832950364;
    l3Weights[3][20] = -0.3051542344620088;
    l3Weights[3][21] = -0.956105995413295;
    l3Weights[3][22] = -0.978783751397559;
    l3Weights[3][23] = 0.9487818680586096;
    l3Weights[3][24] = 1.0060489210493673;
    l3Weights[3][25] = 0.6404471836007752;
    l3Weights[3][26] = -0.9499019555921802;
    l3Weights[3][27] = 1.1297681062553417e-07;
    l3Weights[3][28] = -0.7302877775646495;
    l3Weights[3][29] = -0.8040701417469798;
    l3Weights[3][30] = -3.1553176749139e-07;
    l3Weights[3][31] = 0.9837548373220697;
    l3Weights[3][32] = 0.2679524137796386;
    l3Weights[3][33] = -0.13984647415274495;
    l3Weights[3][34] = 0.04056207203315689;
    l3Weights[3][35] = 0.2425606000289254;
    l3Weights[3][36] = 0.04934300519888749;
    l3Weights[3][37] = -0.3642535486709225;
    l3Weights[3][38] = 0.024787746900286813;
    l3Weights[3][39] = 0.7295694395194414;
    l3Weights[3][40] = -0.07348101743687398;
    l3Weights[3][41] = 0.18457530089354984;
    l3Weights[3][42] = 0.33497000815313643;
    l3Weights[3][43] = -0.2108467718226656;
    l3Weights[3][44] = -0.17983438803963733;
    l3Weights[3][45] = -0.11296280616406651;
    l3Weights[3][46] = 0.31317315107763877;
    l3Weights[3][47] = 0.1286027798904196;
    l3Weights[3][48] = -0.3047854803062756;
    l3Weights[3][49] = -0.01270007311492353;
    l3Weights[3][50] = -0.1390462127337521;
    l3Weights[3][51] = 0.0418321955694816;
    l3Weights[3][52] = 0.03278348116230948;
    l3Weights[3][53] = -0.1412909086695337;
    l3Weights[3][54] = -0.3114467678211645;
    l3Weights[3][55] = 0.01550250947060288;
    l3Weights[3][56] = -0.16814574762613183;
    l3Weights[3][57] = -0.07982944704411193;
    l3Weights[3][58] = 0.11376823954763904;
    l3Weights[3][59] = -0.15680334603972454;
    l3Weights[3][60] = -0.10501320939047512;
    l3Weights[3][61] = -0.04468014718083389;
    l3Weights[3][62] = -0.05953233566266308;
    l3Weights[3][63] = 0.07562711421565087;
    l3Weights[4][0] = -0.6000214843773704;
    l3Weights[4][1] = -0.5339560351486016;
    l3Weights[4][2] = -0.873465307169276;
    l3Weights[4][3] = -1.0012744544650813;
    l3Weights[4][4] = 0.9673402079273432;
    l3Weights[4][5] = -0.4676012212164739;
    l3Weights[4][6] = -1.0094067780018474;
    l3Weights[4][7] = 0.6174438698512131;
    l3Weights[4][8] = -2.0301104255017944e-07;
    l3Weights[4][9] = 0.5343860628215265;
    l3Weights[4][10] = -3.960019929501813e-07;
    l3Weights[4][11] = 0.9349887917422554;
    l3Weights[4][12] = 2.8335145841353123e-08;
    l3Weights[4][13] = -0.9733298614454162;
    l3Weights[4][14] = -1.0122761940717817;
    l3Weights[4][15] = -0.6805689036482777;
    l3Weights[4][16] = 0.7794624135605103;
    l3Weights[4][17] = 1.0525691643087542;
    l3Weights[4][18] = -0.9634504583563493;
    l3Weights[4][19] = 0.7266677197723717;
    l3Weights[4][20] = -0.9582987492217946;
    l3Weights[4][21] = -1.0179040390600458;
    l3Weights[4][22] = -0.6173854733293935;
    l3Weights[4][23] = -1.0314923916046699;
    l3Weights[4][24] = 0.9777194428217665;
    l3Weights[4][25] = 0.5105713491866383;
    l3Weights[4][26] = 0.9913599509744456;
    l3Weights[4][27] = 0.8401617032938768;
    l3Weights[4][28] = -0.9571004118183017;
    l3Weights[4][29] = -1.306305306870482e-08;
    l3Weights[4][30] = 0.9098031126725971;
    l3Weights[4][31] = -0.16722088247878236;
    l3Weights[4][32] = 0.008395727621622849;
    l3Weights[4][33] = -0.3113479437436161;
    l3Weights[4][34] = -0.37991806327456457;
    l3Weights[4][35] = 0.028811566920200597;
    l3Weights[4][36] = 0.12790007024626524;
    l3Weights[4][37] = 0.0461581357298651;
    l3Weights[4][38] = 0.18493879009899925;
    l3Weights[4][39] = 0.5008425752556184;
    l3Weights[4][40] = 0.6180892036555773;
    l3Weights[4][41] = -0.33805302153442074;
    l3Weights[4][42] = 0.09488999553657577;
    l3Weights[4][43] = 0.3589093942273889;
    l3Weights[4][44] = 0.027044954980280943;
    l3Weights[4][45] = 0.04243664509493815;
    l3Weights[4][46] = -0.12520328052086108;
    l3Weights[4][47] = 0.19651734499706355;
    l3Weights[4][48] = -0.07453183384500406;
    l3Weights[4][49] = -0.20939439695249157;
    l3Weights[4][50] = 0.011202873571346125;
    l3Weights[4][51] = -0.06112392302977598;
    l3Weights[4][52] = 0.006937796142861782;
    l3Weights[4][53] = -0.2920584467074316;
    l3Weights[4][54] = 0.20282116835139086;
    l3Weights[4][55] = 0.005319805809422933;
    l3Weights[4][56] = 0.05933576219711445;
    l3Weights[4][57] = -0.28666418823581813;
    l3Weights[4][58] = -0.19180852096033124;
    l3Weights[4][59] = 0.29910725375883473;
    l3Weights[4][60] = 0.5810607683261498;
    l3Weights[4][61] = -0.010340436428040499;
    l3Weights[4][62] = 0.1758737540677619;
    l3Weights[4][63] = 0.15747239447839123;
    l3Weights[5][0] = 0.9554432877299089;
    l3Weights[5][1] = 0.5872005290311973;
    l3Weights[5][2] = 0.9689136356502098;
    l3Weights[5][3] = 0.7311230042393543;
    l3Weights[5][4] = -0.8187104171436759;
    l3Weights[5][5] = 0.6137553019271971;
    l3Weights[5][6] = -0.7182083931659833;
    l3Weights[5][7] = 1.0044425691222099;
    l3Weights[5][8] = -0.9941772966783445;
    l3Weights[5][9] = 0.9797323786437017;
    l3Weights[5][10] = -0.7187917163925482;
    l3Weights[5][11] = 0.6714712341646614;
    l3Weights[5][12] = -0.8120259874219058;
    l3Weights[5][13] = 0.49845427318945346;
    l3Weights[5][14] = -0.83325024251781;
    l3Weights[5][15] = -1.0034756566832497;
    l3Weights[5][16] = -0.8841513290952367;
    l3Weights[5][17] = 0.8922229138991818;
    l3Weights[5][18] = -1.0252536370295828;
    l3Weights[5][19] = 0.6208971420119901;
    l3Weights[5][20] = 0.6419545730594796;
    l3Weights[5][21] = 0.5854357473679312;
    l3Weights[5][22] = 1.0360093866183042;
    l3Weights[5][23] = -0.855979691425183;
    l3Weights[5][24] = 0.29511414996034113;
    l3Weights[5][25] = 0.7925084978771865;
    l3Weights[5][26] = 0.40991350198820947;
    l3Weights[5][27] = 2.449127620379987e-07;
    l3Weights[5][28] = 0.8179838611872439;
    l3Weights[5][29] = 0.9668089241739628;
    l3Weights[5][30] = -0.626288443687847;
    l3Weights[5][31] = 0.8589839990848802;
    l3Weights[5][32] = 0.16276640140886628;
    l3Weights[5][33] = -0.3482170079636905;
    l3Weights[5][34] = -0.010817697683325238;
    l3Weights[5][35] = 0.5297517611669516;
    l3Weights[5][36] = 0.34393413271027407;
    l3Weights[5][37] = -0.07134093953293706;
    l3Weights[5][38] = 0.21334258107271678;
    l3Weights[5][39] = -0.24251707164304628;
    l3Weights[5][40] = 0.09329457157426872;
    l3Weights[5][41] = 0.1127121697762255;
    l3Weights[5][42] = 0.05689877997378821;
    l3Weights[5][43] = 0.22586922206232252;
    l3Weights[5][44] = 0.016483922124204218;
    l3Weights[5][45] = -0.0881566392924877;
    l3Weights[5][46] = 0.03285952806115345;
    l3Weights[5][47] = -0.9693271655699894;
    l3Weights[5][48] = -0.04982547450431983;
    l3Weights[5][49] = -0.3058756119486515;
    l3Weights[5][50] = -0.11970322245217455;
    l3Weights[5][51] = -0.04860687902068872;
    l3Weights[5][52] = -0.03519787541574321;
    l3Weights[5][53] = -0.42867817226691995;
    l3Weights[5][54] = -0.16737508642065627;
    l3Weights[5][55] = -0.1919602804237721;
    l3Weights[5][56] = -0.02216207598695804;
    l3Weights[5][57] = -0.012869320972232146;
    l3Weights[5][58] = -0.04654999643275087;
    l3Weights[5][59] = -0.15783589595854386;
    l3Weights[5][60] = 0.0967407359860923;
    l3Weights[5][61] = -0.19666705529526426;
    l3Weights[5][62] = -0.10641194204341405;
    l3Weights[5][63] = 0.14154109889061617;
    l3Weights[6][0] = -0.5616937291214534;
    l3Weights[6][1] = -0.8780103325339507;
    l3Weights[6][2] = -0.5363670011663102;
    l3Weights[6][3] = -0.9976835423680914;
    l3Weights[6][4] = 1.0247110669840467;
    l3Weights[6][5] = -0.45883733626597234;
    l3Weights[6][6] = -0.5898268839651701;
    l3Weights[6][7] = -0.4191698632111797;
    l3Weights[6][8] = -7.140344206690652e-07;
    l3Weights[6][9] = 0.685838676675621;
    l3Weights[6][10] = 0.6173414376422353;
    l3Weights[6][11] = 0.2224506054541007;
    l3Weights[6][12] = -0.6502494600179932;
    l3Weights[6][13] = -1.0230471783540138;
    l3Weights[6][14] = 8.082695665748963e-08;
    l3Weights[6][15] = -1.5566106301813884e-07;
    l3Weights[6][16] = -0.48576720191396877;
    l3Weights[6][17] = -0.5904836544709038;
    l3Weights[6][18] = -0.8486800859960709;
    l3Weights[6][19] = -1.0047623251186284;
    l3Weights[6][20] = 0.8148525806919973;
    l3Weights[6][21] = 0.6373355531707262;
    l3Weights[6][22] = 0.6498101505273044;
    l3Weights[6][23] = -0.6100329962187091;
    l3Weights[6][24] = 0.7104656547255708;
    l3Weights[6][25] = 0.5815698195949148;
    l3Weights[6][26] = -0.6745220718484687;
    l3Weights[6][27] = 0.6127162999802901;
    l3Weights[6][28] = -0.8256605883013552;
    l3Weights[6][29] = -0.7401671156820607;
    l3Weights[6][30] = 1.019432747312227;
    l3Weights[6][31] = 0.7453751798024852;
    l3Weights[6][32] = 0.0021750895814379497;
    l3Weights[6][33] = 0.7937743040543787;
    l3Weights[6][34] = -0.3512981444826369;
    l3Weights[6][35] = -0.017119745472447625;
    l3Weights[6][36] = -0.2379382053171136;
    l3Weights[6][37] = 0.21342741209856642;
    l3Weights[6][38] = -0.19595570817779986;
    l3Weights[6][39] = -0.47914722347183897;
    l3Weights[6][40] = -0.5072935862437871;
    l3Weights[6][41] = -0.15844927451175098;
    l3Weights[6][42] = 0.06146341389961012;
    l3Weights[6][43] = 0.1630965860623063;
    l3Weights[6][44] = 0.11552014643899164;
    l3Weights[6][45] = 0.15242397574314123;
    l3Weights[6][46] = -0.622894760900385;
    l3Weights[6][47] = 0.2181510205684233;
    l3Weights[6][48] = 0.06551495993726178;
    l3Weights[6][49] = -0.024644159671946993;
    l3Weights[6][50] = -0.11005510315086686;
    l3Weights[6][51] = -0.1892358288145642;
    l3Weights[6][52] = -0.005691469686284194;
    l3Weights[6][53] = 0.24700259001387082;
    l3Weights[6][54] = -0.009377338813265898;
    l3Weights[6][55] = 0.11256108267627704;
    l3Weights[6][56] = 0.27495105127412955;
    l3Weights[6][57] = -0.11670901252521036;
    l3Weights[6][58] = 0.17037320151454577;
    l3Weights[6][59] = 0.04361750109088772;
    l3Weights[6][60] = -0.04646157035391412;
    l3Weights[6][61] = -0.04893050030868924;
    l3Weights[6][62] = 0.10815053797989392;
    l3Weights[6][63] = 0.11519535283693987;
    l3Weights[7][0] = -0.42493124508688696;
    l3Weights[7][1] = 1.0095218562989066;
    l3Weights[7][2] = -0.48350998921384414;
    l3Weights[7][3] = 1.0108397954878925;
    l3Weights[7][4] = -0.7421835485466183;
    l3Weights[7][5] = 0.13784346012142096;
    l3Weights[7][6] = 0.8740592248581599;
    l3Weights[7][7] = 2.1553988175023568e-08;
    l3Weights[7][8] = -0.5881097092028994;
    l3Weights[7][9] = -0.3054728599862931;
    l3Weights[7][10] = 0.6461808744978025;
    l3Weights[7][11] = 0.1052237626689824;
    l3Weights[7][12] = -0.951062594237417;
    l3Weights[7][13] = -0.41227694022365274;
    l3Weights[7][14] = -1.829863946288406e-07;
    l3Weights[7][15] = 0.5326635660947489;
    l3Weights[7][16] = 0.9491597768438993;
    l3Weights[7][17] = 1.9879336487897413e-07;
    l3Weights[7][18] = -0.9692276528306396;
    l3Weights[7][19] = 0.7341282932560148;
    l3Weights[7][20] = -0.5880119780198977;
    l3Weights[7][21] = -0.6594646194333759;
    l3Weights[7][22] = -2.4733371831000555e-07;
    l3Weights[7][23] = -4.597311303791039e-07;
    l3Weights[7][24] = -0.6717043717419274;
    l3Weights[7][25] = -1.453675380907411e-09;
    l3Weights[7][26] = -0.463429008444028;
    l3Weights[7][27] = -7.060634792211798e-07;
    l3Weights[7][28] = -0.9440140327061197;
    l3Weights[7][29] = -0.8330506341527278;
    l3Weights[7][30] = -0.2773319182321199;
    l3Weights[7][31] = -0.336149062841209;
    l3Weights[7][32] = 0.06364423736477626;
    l3Weights[7][33] = 0.0216444601452353;
    l3Weights[7][34] = -0.16831439115719812;
    l3Weights[7][35] = 0.6204784312326014;
    l3Weights[7][36] = -0.20074561405700767;
    l3Weights[7][37] = -0.3901520202136129;
    l3Weights[7][38] = -0.1575510574927217;
    l3Weights[7][39] = 0.015859913162244273;
    l3Weights[7][40] = 0.20812283607147694;
    l3Weights[7][41] = 0.13524188501269932;
    l3Weights[7][42] = 0.022218833542861548;
    l3Weights[7][43] = -0.41168596420504294;
    l3Weights[7][44] = -0.03264253781446058;
    l3Weights[7][45] = -0.032689361256203184;
    l3Weights[7][46] = -0.0074894716510049255;
    l3Weights[7][47] = 0.11698248919949465;
    l3Weights[7][48] = 0.4172481126935714;
    l3Weights[7][49] = 0.13006113425261095;
    l3Weights[7][50] = -0.06375921194281688;
    l3Weights[7][51] = -0.2590386277783231;
    l3Weights[7][52] = -0.14136019842368924;
    l3Weights[7][53] = 0.34237250394767216;
    l3Weights[7][54] = 0.01506171827760677;
    l3Weights[7][55] = -0.30068871014100795;
    l3Weights[7][56] = 0.1498106182803262;
    l3Weights[7][57] = 0.1295919482191478;
    l3Weights[7][58] = 0.4979318436275456;
    l3Weights[7][59] = 0.226814169332311;
    l3Weights[7][60] = 0.022606148283574486;
    l3Weights[7][61] = 0.09980382095388475;
    l3Weights[7][62] = -0.41969499708982333;
    l3Weights[7][63] = -0.06685145513880765;
