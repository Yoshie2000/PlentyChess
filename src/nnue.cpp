...
Eval NNUE::evaluate(Board* board) {
  ...
  // ---------------------- FT ACTIVATION & PAIRWISE ----------------------
    ...
    for (int pw = 0; pw < pairwiseOffset; pw += 2) {
        // STM
        VecI16 clipped1 = minEpi16(maxEpi16(addEpi16(slliEpi16(stmPieceAcc[pw], 1), stmThreatAcc[pw]), i16Zero), i16Quant);
        VecI16 clipped2 = minEpi16(addEpi16(slliEpi16(stmPieceAcc[pw + pairwiseOffset], 1), stmThreatAcc[pw + pairwiseOffset]), i16Quant);
        ...
        clipped1 = minEpi16(maxEpi16(addEpi16(slliEpi16(stmPieceAcc[pw + 1], 1), stmThreatAcc[pw + 1]), i16Zero), i16Quant);
        clipped2 = minEpi16(addEpi16(slliEpi16(stmPieceAcc[pw + 1 + pairwiseOffset], 1), stmThreatAcc[pw + 1 + pairwiseOffset]), i16Quant);
        ...
        // NSTM
        clipped1 = minEpi16(maxEpi16(addEpi16(slliEpi16(oppPieceAcc[pw], 1), oppThreatAcc[pw]), i16Zero), i16Quant);
        clipped2 = minEpi16(addEpi16(slliEpi16(oppPieceAcc[pw + pairwiseOffset], 1), oppThreatAcc[pw + pairwiseOffset]), i16Quant);
        shift1 = slliEpi16(clipped1, INPUT_SHIFT_1);
        shift2 = slliEpi16(clipped2, INPUT_SHIFT_2);
        mul1 = mulhiEpi16(shift1, shift2);

        clipped1 = minEpi16(maxEpi16(addEpi16(slliEpi16(oppPieceAcc[pw + 1], 1), oppThreatAcc[pw + 1]), i16Zero), i16Quant);
        clipped2 = minEpi16(addEpi16(slliEpi16(oppPieceAcc[pw + 1 + pairwiseOffset], 1), oppThreatAcc[pw + 1 + pairwiseOffset]), i16Quant);
        shift1 = slliEpi16(clipped1, INPUT_SHIFT_1);
        shift2 = slliEpi16(clipped2, INPUT_SHIFT_2);
