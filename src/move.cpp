...
TUNE_INT(mpSeeDivisor, 73, 10, 150);

TUNE_INT(mpThreatQueenValue, 20967, 10000, 30000);
TUNE_INT(mpThreatRookValue, 12338, 7500, 17500);
TUNE_INT(mpThreatKnightValue, 8010, 5000, 10000);
