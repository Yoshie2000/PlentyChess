...
TUNE_INT(maxTimeFactor, 738, 500, 1000);
TUNE_INT(totalTimeDivisor, 142, 50, 500);
TUNE_INT(totalTimeIncrementDivisor, 11, 5, 50);
TUNE_FLOAT(optTimeFactor, 0.8198914622991481f, 0.5f, 1.5f);
TUNE_FLOAT(maxTimeFactor2, 2.654106172447742f, 1.5f, 3.5f);
