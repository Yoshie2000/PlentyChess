...
TUNE_INT(maxTimeFactor, 751, 0, 1500);
TUNE_INT(totalTimeDivisor, 141, 0, 300);
TUNE_INT(totalTimeIncrementDivisor, 15, 0, 30);
TUNE_FLOAT(optTimeFactor, 0.8399453763852353f, 0.0f, 1.5f);
TUNE_FLOAT(maxTimeFactor2, 2.745510930271531f, 0.0f, 5.0f);
