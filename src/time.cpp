...
TUNE_INT(maxTimeFactor, 750, 500, 1000);
TUNE_INT(totalTimeDivisor, 200, 50, 500);
TUNE_INT(totalTimeIncrementDivisor, 20, 5, 50);
TUNE_FLOAT(optTimeFactor, 0.8f, 0.5f, 1.5f);
TUNE_FLOAT(maxTimeFactor2, 2.5f, 1.5f, 3.5f);
