...
TUNE_FLOAT_DISABLED(seeMarginNoisy, -24.47291348333615f, -50.0f, -10.0f);
TUNE_FLOAT_DISABLED(seeMarginQuiet, -76.22223052179581f, -100.0f, -50.0f);
TUNE_FLOAT_DISABLED(lmpMarginWorseningBase, 2.0264034228074035f, -1.0f, 2.5f);
TUNE_FLOAT_DISABLED(lmpMarginWorseningFactor, 0.36773070268987235f, 0.1f, 1.5f);
TUNE_FLOAT_DISABLED(lmpMarginWorseningPower, 1.6488172531400145f, 1.0f, 3.0f);
TUNE_FLOAT_DISABLED(lmpMarginImprovingBase, 2.9529829700559365f, 2.0f, 5.0f);
TUNE_FLOAT_DISABLED(lmpMarginImprovingFactor, 0.8372651393568566f, 0.5f, 2.0f);
TUNE_FLOAT_DISABLED(lmpMarginImprovingPower, 1.974333065229244f, 1.0f, 3.0f);
...
// In-search pruning
TUNE_INT_DISABLED(earlyLmrHistoryFactorQuiet, 16277, 10000, 20000);
TUNE_INT_DISABLED(earlyLmrHistoryFactorCapture, 14971, 10000, 20000);

TUNE_INT_DISABLED(fpDepth, 11, 1, 20);
TUNE_INT_DISABLED(fpBase, 216, 1, 1000);
TUNE_INT_DISABLED(fpFactor, 107, 1, 500);

TUNE_INT_DISABLED(fpCaptDepth, 9, 1, 20);
TUNE_INT_DISABLED(fpCaptBase, 411, 150, 750);
TUNE_INT_DISABLED(fpCaptFactor, 376, 100, 600);

TUNE_INT_DISABLED(historyPruningDepth, 4, 1, 15);
TUNE_INT_DISABLED(historyPruningFactorCapture, -1727, -8192, -128);
TUNE_INT_DISABLED(historyPruningFactorQuiet, -6019, -8192, -128);
