...
TUNE_FLOAT_DISABLED(lmrReductionNoisyBase, -0.5, -5.00f, 5.00f); // -0.1782
TUNE_FLOAT_DISABLED(lmrReductionNoisyFactor, 3.0, 1.00f, 10.00f); // 3.2148
TUNE_FLOAT_DISABLED(lmrReductionQuietBase, 1.25, -5.00f, 5.00f); // 1.0577
TUNE_FLOAT_DISABLED(lmrReductionQuietFactor, 3.0, 1.00f, 10.00f); // 2.6368

TUNE_FLOAT_DISABLED(seeMarginNoisy, -25.0, -100.0f, -1.0f); // -24.2315
TUNE_FLOAT_DISABLED(seeMarginQuiet, -75.0, -200.0f, -1.0f); // -71.7102
TUNE_FLOAT_DISABLED(lmpMarginWorseningBase, 1.42, -2.5f, 10.0f); // 2.1576
TUNE_FLOAT_DISABLED(lmpMarginWorseningFactor, 0.5, 0.05f, 2.5f); // 0.5731
TUNE_FLOAT_DISABLED(lmpMarginWorseningPower, 1.8, 0.5f, 5.0f); // 1.7130
TUNE_FLOAT_DISABLED(lmpMarginImprovingBase, 3.5, -2.5f, 10.0f); // 2.9163
TUNE_FLOAT_DISABLED(lmpMarginImprovingFactor, 1.1, 0.05f, 2.5f); // 1.1387
TUNE_FLOAT_DISABLED(lmpMarginImprovingPower, 2.0, 0.5f, 5.0f); // 1.8248
