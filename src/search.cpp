...
// Time management
TUNE_FLOAT(tmInitialAdjustment, 1.0796307320901835f, 0.0f, 2.0f);
TUNE_INT(tmBestMoveStabilityMax, 18, 0, 40);
TUNE_FLOAT(tmBestMoveStabilityBase, 1.5114270553993898f, 0.0f, 3.0f);
TUNE_FLOAT(tmBestMoveStabilityFactor, 0.05192744990530549f, 0.0f, 0.1f);
TUNE_FLOAT(tmEvalDiffBase, 0.9640137856251421f, 0.0f, 2.0f);
TUNE_FLOAT(tmEvalDiffFactor, 0.0038870466506728298f, 0.0f, 0.008f);
TUNE_INT(tmEvalDiffMin, -9, -150, 50);
TUNE_INT(tmEvalDiffMax, 63, -50, 150);
TUNE_FLOAT(tmNodesBase, 1.6874618043176948f, 0.0f, 3.25f);
TUNE_FLOAT(tmNodesFactor, 0.921048521228935f, 0.0f, 2.0f);
...
TUNE_INT_DISABLED(aspirationWindowDeltaDivisor, 12681, 7500, 17500);
...
TUNE_FLOAT_DISABLED(lmrReductionNoisyBase, -0.15479789310247533f, -2.0f, -0.1f);
TUNE_FLOAT_DISABLED(lmrReductionNoisyFactor, 3.3112850174104427f, 2.0f, 4.0f);
TUNE_FLOAT_DISABLED(lmrReductionQuietBase, 1.1379245400518583f, 0.50f, 1.5f);
TUNE_FLOAT_DISABLED(lmrReductionQuietFactor, 2.8997689712710466f, 2.0f, 4.0f);

TUNE_FLOAT_DISABLED(seeMarginNoisy, -24.40422689842072f, -50.0f, -10.0f);
TUNE_FLOAT_DISABLED(seeMarginQuiet, -77.46039783122589f, -100.0f, -50.0f);
TUNE_FLOAT_DISABLED(lmpMarginWorseningBase, 1.932336729298966f, -1.0f, 2.5f);
TUNE_FLOAT_DISABLED(lmpMarginWorseningFactor, 0.4372991933478511f, 0.1f, 1.5f);
TUNE_FLOAT_DISABLED(lmpMarginWorseningPower, 1.660804390081005f, 1.0f, 3.0f);
TUNE_FLOAT_DISABLED(lmpMarginImprovingBase, 2.7242843289961067f, 2.0f, 5.0f);
TUNE_FLOAT_DISABLED(lmpMarginImprovingFactor, 0.8277962583165434f, 0.5f, 2.0f);
TUNE_FLOAT_DISABLED(lmpMarginImprovingPower, 1.9124128409053007f, 1.0f, 3.0f);

// Search values
TUNE_INT_DISABLED(qsFutilityOffset, 68, 1, 125);
TUNE_INT_DISABLED(qsSeeMargin, -87, -200, 50);

// Pre-search pruning
TUNE_INT_DISABLED(iirMinDepth, 4, 1, 10);

TUNE_INT_DISABLED(staticHistoryFactor, -61, -500, -1);
TUNE_INT_DISABLED(staticHistoryMin, -161, -1000, -1);
TUNE_INT_DISABLED(staticHistoryMax, 170, 1, 1000);
TUNE_INT_DISABLED(staticHistoryTempo, 36, 1, 1000);

TUNE_INT_DISABLED(rfpDepth, 8, 2, 20);
TUNE_INT_DISABLED(rfpFactor, 96, 1, 250);

TUNE_INT_DISABLED(razoringDepth, 5, 2, 20);
TUNE_INT_DISABLED(razoringFactor, 284, 1, 1000);

TUNE_INT_DISABLED(nmpRedBase, 4, 1, 5);
TUNE_INT_DISABLED(nmpDepthDiv, 3, 1, 6);
TUNE_INT_DISABLED(nmpMin, 4, 1, 10);
TUNE_INT_DISABLED(nmpDivisor, 174, 10, 1000);
TUNE_INT_DISABLED(nmpEvalDepth, 18, 1, 100);
TUNE_INT_DISABLED(nmpEvalBase, 173, 50, 300);

TUNE_INT_DISABLED(probCutBetaOffset, 205, 1, 500);
TUNE_INT_DISABLED(probCutDepth, 5, 1, 15);

// In-search pruning
TUNE_INT_DISABLED(earlyLmrReductionTableFactor, 1014, 500, 2000);

TUNE_INT_DISABLED(earlyLmrHistoryFactorQuiet, 16009, 10000, 20000);
TUNE_INT_DISABLED(earlyLmrHistoryFactorCapture, 14637, 10000, 20000);

TUNE_INT_DISABLED(fpDepth, 11, 1, 20);
TUNE_INT_DISABLED(fpBase, 206, 1, 1000);
TUNE_INT_DISABLED(fpFactor, 101, 1, 500);

TUNE_INT_DISABLED(fpCaptDepth, 9, 1, 20);
TUNE_INT_DISABLED(fpCaptBase, 403, 150, 750);
TUNE_INT_DISABLED(fpCaptFactor, 403, 100, 600);

TUNE_INT_DISABLED(historyPruningDepth, 4, 1, 15);
TUNE_INT_DISABLED(historyPruningFactorCapture, -1879, -8192, -128);
TUNE_INT_DISABLED(historyPruningFactorQuiet, -6129, -8192, -128);
...
TUNE_INT_DISABLED(lmrCheck, 881, 0, 5000);
TUNE_INT_DISABLED(lmrTtPv, 1943, 0, 5000);
TUNE_INT_DISABLED(lmrCutnode, 1841, 0, 5000);
TUNE_INT_DISABLED(lmrTtpvFaillow, 889, 0, 5000);
TUNE_INT_DISABLED(lmrCorrection, 15162, 1000, 20000);
TUNE_INT_DISABLED(lmrHistoryFactorQuiet, 25301, 10000, 30000);
TUNE_INT_DISABLED(lmrHistoryFactorCapture, 309944, 250000, 400000);

TUNE_INT_DISABLED(postlmrOppWorseningThreshold, 3031, 1500, 4500);

TUNE_INT_DISABLED(lmrDeeperBase, 40, 1, 100);
TUNE_INT_DISABLED(lmrDeeperFactor, 2, 0, 10);

TUNE_INT_DISABLED(lmrPassBonusBase, -311, -500, 500);
TUNE_INT_DISABLED(lmrPassBonusFactor, 190, 1, 500);
TUNE_INT_DISABLED(lmrPassBonusMax, 1023, 32, 4096);

TUNE_INT_DISABLED(historyDepthBetaOffset, 247, 1, 500);

TUNE_INT_DISABLED(correctionHistoryFactor, 163, 32, 512);
