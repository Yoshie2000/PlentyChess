...
TUNE_INT(aspirationWindowDeltaDivisor, 12657, 7500, 17500);
...
TUNE_FLOAT(lmrReductionNoisyBase, -0.18254791476537288f, -2.0f, -0.1f);
TUNE_FLOAT(lmrReductionNoisyFactor, 3.2684877342490752f, 2.0f, 4.0f);
TUNE_FLOAT(lmrReductionQuietBase, 1.1016018216330363f, 0.50f, 1.5f);
TUNE_FLOAT(lmrReductionQuietFactor, 3.036019776046099f, 2.0f, 4.0f);

TUNE_FLOAT(seeMarginNoisy, -22.747590286948185f, -50.0f, -10.0f);
TUNE_FLOAT(seeMarginQuiet, -73.66041805588861f, -100.0f, -50.0f);
TUNE_FLOAT(lmpMarginWorseningBase, 2.0010290767942833f, -1.0f, 2.5f);
TUNE_FLOAT(lmpMarginWorseningFactor, 0.4403981262386373f, 0.1f, 1.5f);
TUNE_FLOAT(lmpMarginWorseningPower, 1.7107627544475879f, 1.0f, 3.0f);
TUNE_FLOAT(lmpMarginImprovingBase, 2.677904355273982f, 2.0f, 5.0f);
TUNE_FLOAT(lmpMarginImprovingFactor, 0.8338342827833406f, 0.5f, 2.0f);
TUNE_FLOAT(lmpMarginImprovingPower, 2.0198627815742065f, 1.0f, 3.0f);
...
TUNE_INT(staticHistoryFactor, -62, -500, -1);
TUNE_INT(staticHistoryMin, -195, -1000, -1);
TUNE_INT(staticHistoryMax, 166, 1, 1000);
TUNE_INT(staticHistoryTempo, 66, 1, 1000);

TUNE_INT_DISABLED(rfpDepth, 8, 2, 20);
TUNE_INT(rfpFactor, 101, 1, 250);

TUNE_INT_DISABLED(razoringDepth, 5, 2, 20);
TUNE_INT(razoringFactor, 258, 1, 1000);

TUNE_INT_DISABLED(nmpRedBase, 4, 1, 5);
TUNE_INT_DISABLED(nmpDepthDiv, 3, 1, 6);
TUNE_INT_DISABLED(nmpMin, 4, 1, 10);
TUNE_INT(nmpDivisor, 169, 10, 1000);
TUNE_INT(nmpEvalDepth, 17, 1, 100);
TUNE_INT(nmpEvalBase, 166, 50, 300);

TUNE_INT(probCutBetaOffset, 190, 1, 500);
TUNE_INT_DISABLED(probCutDepth, 5, 1, 15);

// In-search pruning
TUNE_INT(earlyLmrReductionTableFactor, 975, 500, 2000);

TUNE_INT(earlyLmrHistoryFactorQuiet, 16172, 10000, 20000);
TUNE_INT(earlyLmrHistoryFactorCapture, 14502, 10000, 20000);

TUNE_INT_DISABLED(fpDepth, 11, 1, 20);
TUNE_INT(fpBase, 152, 1, 1000);
TUNE_INT(fpFactor, 102, 1, 500);

TUNE_INT_DISABLED(fpCaptDepth, 9, 1, 20);
TUNE_INT(fpCaptBase, 407, 150, 750);
TUNE_INT(fpCaptFactor, 389, 100, 600);

TUNE_INT_DISABLED(historyPruningDepth, 4, 1, 15);
TUNE_INT(historyPruningFactorCapture, -1795, -8192, -128);
TUNE_INT(historyPruningFactorQuiet, -6224, -8192, -128);
...
TUNE_INT(lmrCheck, 991, 0, 5000);
TUNE_INT(lmrTtPv, 2082, 0, 5000);
TUNE_INT(lmrCutnode, 1751, 0, 5000);
TUNE_INT(lmrTtpvFaillow, 957, 0, 5000);
TUNE_INT(lmrCorrection, 14751, 1000, 20000);
TUNE_INT(lmrHistoryFactorQuiet, 25003, 10000, 30000);
TUNE_INT(lmrHistoryFactorCapture, 308720, 250000, 400000);

TUNE_INT(postlmrOppWorseningThreshold, 2893, 1500, 4500);

TUNE_INT_DISABLED(lmrDeeperBase, 40, 1, 100);
TUNE_INT_DISABLED(lmrDeeperFactor, 2, 0, 10);

TUNE_INT(lmrPassBonusBase, -274, -500, 500);
TUNE_INT(lmrPassBonusFactor, 192, 1, 500);
TUNE_INT(lmrPassBonusMax, 1138, 32, 4096);

TUNE_INT(historyDepthBetaOffset, 242, 1, 500);
