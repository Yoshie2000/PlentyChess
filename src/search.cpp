...
TUNE_INT(doubleExtensionMargin, 25, 0, 150);
TUNE_INT(doubleExtensionLimit, 12, 0, 50);
...
TUNE_INT(lmrPassBonusOffset, 0, -1000, 1000);

TUNE_INT(historyBonusFactor, 160, 1, 1000);
TUNE_INT(historyBonusMax, 1757, 32, 8192);
TUNE_INT(historyBonusOffset, 0, -1000, 1000);
