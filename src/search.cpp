...
constexpr int RANDOMISED_REDUCTION_SIZE = 8192;
constexpr int RANDOMISED_REDUCTION_MEAN = 5;
constexpr int RANDOMISED_REDUCTION_STDDEV = 5;
constexpr int RANDOMISED_REDUCTION_MAX = 25;
