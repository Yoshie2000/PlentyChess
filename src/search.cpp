...
// Time management
TUNE_FLOAT_DISABLED(tmInitialAdjustment, 1.1032702333287274f, 0.5f, 1.5f);
TUNE_INT_DISABLED(tmBestMoveStabilityMax, 18, 10, 30);
TUNE_FLOAT_DISABLED(tmBestMoveStabilityBase, 1.5566568431651606f, 0.75f, 2.5f);
TUNE_FLOAT_DISABLED(tmBestMoveStabilityFactor, 0.05191442558388895f, 0.001f, 0.1f);
TUNE_FLOAT_DISABLED(tmEvalDiffBase, 0.9593217805964583f, 0.5f, 1.5f);
TUNE_FLOAT_DISABLED(tmEvalDiffFactor, 0.0039848532750552616f, 0.001f, 0.1f);
TUNE_INT_DISABLED(tmEvalDiffMin, -8, -250, 50);
TUNE_INT_DISABLED(tmEvalDiffMax, 64, -50, 250);
TUNE_FLOAT_DISABLED(tmNodesBase, 1.6946375374757434f, 0.5f, 5.0f);
TUNE_FLOAT_DISABLED(tmNodesFactor, 0.9316633089139892f, 0.1f, 2.5f);
