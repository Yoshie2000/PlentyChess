...
TUNE_INT(aspirationWindowMaxFailHighs, 4, 0, 20);
TUNE_FLOAT(aspirationWindowDeltaFactor, 1.7333785012799803f, 1.0f, 10.0f);

// Reduction / Margin tables
TUNE_FLOAT(lmrReductionNoisyBase, -0.5932864374362409f, -5.00f, 5.00f);
TUNE_FLOAT(lmrReductionNoisyFactor, 2.9544907326280367, 1.00f, 10.00f);
TUNE_FLOAT(lmrReductionQuietBase, 0.6667187192988394f, -5.00f, 5.00f);
TUNE_FLOAT(lmrReductionQuietFactor, 2.852942388249985f, 1.00f, 10.00f);

TUNE_FLOAT(seeMarginNoisy, -26.11944911811245f, -100.0f, -1.0f);
TUNE_FLOAT(seeMarginQuiet, -74.43200829007709f, -200.0f, -1.0f);
TUNE_FLOAT(lmpMarginWorseningBase, 1.4729531767129012f, -2.5f, 10.0f);
TUNE_FLOAT(lmpMarginWorseningFactor, 0.4611153340879597f, 0.05f, 2.5f);
TUNE_FLOAT(lmpMarginWorseningPower, 1.79465579124245f, 0.5f, 5.0f);
TUNE_FLOAT(lmpMarginImprovingBase, 3.0571588208332217f, -2.5f, 10.0f);
TUNE_FLOAT(lmpMarginImprovingFactor, 1.0195873667536086f, 0.05f, 2.5f);
TUNE_FLOAT(lmpMarginImprovingPower, 1.8825797237505153f, 0.5f, 5.0f);
...
TUNE_INT(lmrHistoryFactor, 12820, 128, 32768);
TUNE_INT(lmrDeeperBase, 42, 1, 200);
TUNE_INT(lmrDeeperFactor, 2, 0, 10);

TUNE_INT(lmrPassBonusFactor, 11, 1, 32);
TUNE_INT(lmrPassBonusMax, 1255, 32, 8192);

TUNE_INT(historyBonusFactor, 16, 1, 32);
TUNE_INT(historyBonusMax, 1777, 32, 8192);
