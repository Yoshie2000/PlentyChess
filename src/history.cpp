...
// Quiet history
TUNE_INT_DISABLED(historyBonusQuietBase, 24, -500, 500);
TUNE_INT_DISABLED(historyBonusQuietFactor, 227, 1, 500);
TUNE_INT_DISABLED(historyBonusQuietMax, 1997, 32, 4096);
TUNE_INT_DISABLED(historyMalusQuietBase, 69, -500, 500);
TUNE_INT_DISABLED(historyMalusQuietFactor, 196, 1, 500);
TUNE_INT_DISABLED(historyMalusQuietMax, 1583, 32, 4096);

// Continuation history
TUNE_INT_DISABLED(historyBonusContinuationBase, 0, -500, 500);
TUNE_INT_DISABLED(historyBonusContinuationFactor, 216, 1, 500);
TUNE_INT_DISABLED(historyBonusContinuationMax, 2316, 32, 4096);
TUNE_INT_DISABLED(historyMalusContinuationBase, 94, -500, 500);
TUNE_INT_DISABLED(historyMalusContinuationFactor, 211, 1, 500);
TUNE_INT_DISABLED(historyMalusContinuationMax, 1556, 32, 4096);

// Pawn history
TUNE_INT_DISABLED(historyBonusPawnBase, -2, -500, 500);
TUNE_INT_DISABLED(historyBonusPawnFactor, 203, 1, 500);
TUNE_INT_DISABLED(historyBonusPawnMax, 2424, 32, 4096);
TUNE_INT_DISABLED(historyMalusPawnBase, 64, -500, 500);
TUNE_INT_DISABLED(historyMalusPawnFactor, 251, 1, 500);
TUNE_INT_DISABLED(historyMalusPawnMax, 1909, 32, 4096);

// Capture history
TUNE_INT_DISABLED(historyBonusCaptureBase, 31, -500, 500);
TUNE_INT_DISABLED(historyBonusCaptureFactor, 141, 1, 500);
TUNE_INT_DISABLED(historyBonusCaptureMax, 1834, 32, 4096);
TUNE_INT_DISABLED(historyMalusCaptureBase, 150, -500, 500);
TUNE_INT_DISABLED(historyMalusCaptureFactor, 243, 1, 500);
TUNE_INT_DISABLED(historyMalusCaptureMax, 1904, 32, 4096);

// Correction history
TUNE_INT_DISABLED(pawnCorrectionFactor, 5920, 1000, 7500);
TUNE_INT_DISABLED(nonPawnCorrectionFactor, 5576, 1000, 7500);
TUNE_INT_DISABLED(minorCorrectionFactor, 3681, 1000, 7500);
TUNE_INT_DISABLED(majorCorrectionFactor, 3125, 1000, 7500);
TUNE_INT_DISABLED(continuationCorrectionFactor, 5129, 1000, 7500);
