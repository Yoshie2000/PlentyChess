...
// Quiet history
TUNE_INT(historyBonusQuietBase, 34, -500, 500);
TUNE_INT(historyBonusQuietFactor, 207, 1, 500);
TUNE_INT(historyBonusQuietMax, 2078, 32, 4096);
TUNE_INT(historyMalusQuietBase, 51, -500, 500);
TUNE_INT(historyMalusQuietFactor, 184, 1, 500);
TUNE_INT(historyMalusQuietMax, 1460, 32, 4096);

// Continuation history
TUNE_INT(historyBonusContinuationBase, -54, -500, 500);
TUNE_INT(historyBonusContinuationFactor, 218, 1, 500);
TUNE_INT(historyBonusContinuationMax, 2388, 32, 4096);
TUNE_INT(historyMalusContinuationBase, 66, -500, 500);
TUNE_INT(historyMalusContinuationFactor, 219, 1, 500);
TUNE_INT(historyMalusContinuationMax, 1536, 32, 4096);

// Pawn history
TUNE_INT(historyBonusPawnBase, 25, -500, 500);
TUNE_INT(historyBonusPawnFactor, 214, 1, 500);
TUNE_INT(historyBonusPawnMax, 2438, 32, 4096);
TUNE_INT(historyMalusPawnBase, 59, -500, 500);
TUNE_INT(historyMalusPawnFactor, 262, 1, 500);
TUNE_INT(historyMalusPawnMax, 1954, 32, 4096);

// Capture history
TUNE_INT(historyBonusCaptureBase, 61, -500, 500);
TUNE_INT(historyBonusCaptureFactor, 139, 1, 500);
TUNE_INT(historyBonusCaptureMax, 1867, 32, 4096);
TUNE_INT(historyMalusCaptureBase, 130, -500, 500);
TUNE_INT(historyMalusCaptureFactor, 245, 1, 500);
TUNE_INT(historyMalusCaptureMax, 1899, 32, 4096);

// Correction history
TUNE_INT(pawnCorrectionFactor, 6072, 1000, 7500);
TUNE_INT(nonPawnCorrectionFactor, 5410, 1000, 7500);
TUNE_INT(minorCorrectionFactor, 3694, 1000, 7500);
TUNE_INT(majorCorrectionFactor, 3036, 1000, 7500);
TUNE_INT(continuationCorrectionFactor, 5312, 1000, 7500);
