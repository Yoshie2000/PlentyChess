...
TUNE_INT_DISABLED(pawnCorrectionFactor, 5759, 1000, 7500);
TUNE_INT_DISABLED(nonPawnCorrectionFactor, 5457, 1000, 7500);
TUNE_INT_DISABLED(minorCorrectionFactor, 3490, 1000, 7500);
TUNE_INT_DISABLED(majorCorrectionFactor, 3015, 1000, 7500);
TUNE_INT_DISABLED(continuationCorrectionFactor, 5226, 1000, 7500);
