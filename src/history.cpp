...
TUNE_INT(pawnCorrectionFactor, 6135, 10, 5000);
TUNE_INT(nonPawnCorrectionFactor, 5795, 10, 5000);
TUNE_INT(minorCorrectionFactor, 3710, 10, 5000);
TUNE_INT(majorCorrectionFactor, 3223, 10, 5000);
TUNE_INT(continuationCorrectionFactor, 5520, 10, 5000);
