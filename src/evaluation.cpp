...
TUNE_INT(materialScalePawnValue, 90, 1, 200);
TUNE_INT(materialScaleKnightValue, 288, 1, 600);
TUNE_INT(materialScaleBishopValue, 311, 1, 600);
TUNE_INT(materialScaleRookValue, 502, 1, 1000);
TUNE_INT(materialScaleQueenValue, 1098, 1, 2000);

TUNE_INT(optimismBase, 2013, 1, 4000);
TUNE_INT(materialScaleBase, 32072, 1, 60000);
TUNE_INT(evalScaleDivisor, 41594, 1, 80000);
