...
public:
    ...
    void updateCaptureHistory(int16_t bonusDepth, int16_t malusDepth, Board* board, Move move, int moveSearchCount, Move* captureMoves, int* captureSearchCount, int captureMoveCount);

    void updateQuietHistories(int16_t bonusDepth, int16_t malusDepth, Board* board, SearchStack* stack, Move move, int moveSearchCount, Move* quietMoves, int* quietSearchCount, int quietMoveCount);
