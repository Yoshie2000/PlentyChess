...
class History {
    ...
    int16_t nonPawnHistory[PAWN_HISTORY_SIZE][2][Piece::TOTAL][64];
...
public:
    ...
    int16_t getNonPawnHistory(Board* board, Move move);
    void updateNonPawnHistory(Board* board, Move move, int16_t bonus);
