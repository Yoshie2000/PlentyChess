...
class History {
    ...
    int16_t recaptureHistory[2][Piece::TOTAL][64][Piece::TOTAL + 1];
...
public:
    ...
    int16_t* getRecaptureHistory(Board* board, Move move);
    void updateSingleRecaptureHistory(Board* board, Move move, int16_t bonus);
