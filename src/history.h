...
public:
    ...
    int16_t getPawnHistory(Color stm, BoardStack* stack, Piece movedPiece, Move move);
    void updatePawnHistory(Color stm, BoardStack* stack, Piece movedPiece, Move move, int16_t bonus);
