...
public:
    ...
    int16_t getPawnHistory(BoardStack* stack, Color stm, Piece movedPiece, Move move);
    void updatePawnHistory(BoardStack* stack, Color stm, Piece movedPiece, Move move, int16_t bonus);
